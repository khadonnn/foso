...
<Components.BreadCrumbSection
  list={["Trang chủ", "Tài nguyên", "Blog", "Quản lý sản xuất"]}
/>
...
<Components.ImageSection src={images.image5s_2.src} />
...
<Components.ImageSection src={images.image5s_3.src} />
...
<Components.ImageSection src={images.image5s_4.src} />
...
<Components.CalloutSection>
  Về Kaizen, thì đây được xem là một triết lý cải tiến liên tục tong doanh
  nghiệp. Phương pháp này nhằm tạo ra sự thay đổi tích cực, mang tính liên tục
  và bền vững. 
</Components.CalloutSection>

<Components.CalloutSection>
  Còn đối với quy tắc 5S, đây là một phương pháp quản lý và cải tiến trong sản
  xuất. 5S tập trung vào việc sắp xếp, sạch sẽ, sắp đặt, tiêu chuẩn hóa và kỷ
  luật trong môi trường làm việc.  
</Components.CalloutSection>
...
<Components.ImageSection src={images.image5s_5.src} />
